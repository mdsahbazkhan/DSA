...
function findMedianSortedArrays(arr1, arr2) {
  ...
  while (low <= high) {
    ...
    if (mid1 < n1) r1 = arr1[mid1]; // right element of a
    if (mid2 < n2) r2 = arr2[mid2]; // right element of b
    if (mid1 - 1 >= 0) l1 = arr1[mid1 - 1]; // left element of a
...
console.log(findMedianSortedArrays([1, 3, 4, 7, 10, 12], [2, 3, 6, 15]));
